        ...
        <aside className="action-panel">
          ...
          <div className="share-panel">
            ...
            <div className="share-grid">
              <a className="button button--outline button--sm share-icon-button share-icon-button--whatsapp" href={whatsappUrl} target="_blank" rel="noreferrer" aria-label="Compartilhar no WhatsApp" title="WhatsApp" onClick={() => trackEvent("share_interest", { method: "whatsapp", interest_id: resolvedInterest.id })}><span className="brand-icon brand-icon--whatsapp"><WhatsAppIcon /></span></a>
              <a className="button button--outline button--sm share-icon-button share-icon-button--x" href={xUrl} target="_blank" rel="noreferrer" aria-label="Compartilhar no X" title="X" onClick={() => trackEvent("share_interest", { method: "x", interest_id: resolvedInterest.id })}><span className="brand-icon brand-icon--x"><XBrandIcon /></span></a>
              <a className="button button--outline button--sm share-icon-button share-icon-button--facebook" href={facebookUrl} target="_blank" rel="noreferrer" aria-label="Compartilhar no Facebook" title="Facebook" onClick={() => trackEvent("share_interest", { method: "facebook", interest_id: resolvedInterest.id })}><span className="brand-icon brand-icon--facebook"><FacebookIcon /></span></a>
