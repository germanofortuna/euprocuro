...
export const STICKER_SELECTIONS: StickerSelection[] = [
  { group: "A", name: "Mexico", emblem: "MX" },
  { group: "A", name: "Africa do Sul", emblem: "ZA" },
  { group: "A", name: "Coreia do Sul", emblem: "KR" },
  ...
  { group: "E", name: "Curacao", emblem: "CW" },
  { group: "E", name: "Costa do Marfim", emblem: "CI" },
  { group: "E", name: "Equador", emblem: "EC" },
  { group: "F", name: "Holanda", emblem: "NL" },
  { group: "F", name: "Japao", emblem: "JP" },
  { group: "F", name: "Suecia", emblem: "SE" },
  { group: "F", name: "Tunisia", emblem: "TN" },
  { group: "G", name: "Belgica", emblem: "BE" },
  { group: "G", name: "Egito", emblem: "EG" },
  { group: "G", name: "Ira", emblem: "IR" },
  { group: "G", name: "Nova Zelandia", emblem: "NZ" },
  { group: "H", name: "Espanha", emblem: "ES" },
  { group: "H", name: "Cabo Verde", emblem: "CV" },
  { group: "H", name: "Arabia Saudita", emblem: "SA" },
  { group: "H", name: "Uruguai", emblem: "UY" },
  { group: "I", name: "Franca", emblem: "FR" },
  ...
  { group: "J", name: "Argelia", emblem: "DZ" },
  { group: "J", name: "Austria", emblem: "AT" },
  { group: "J", name: "Jordania", emblem: "JO" },
  { group: "K", name: "Portugal", emblem: "PT" },
  { group: "K", name: "RD Congo", emblem: "CD" },
  { group: "K", name: "Uzbequistao", emblem: "UZ" },
  { group: "K", name: "Colombia", emblem: "CO" },
  { group: "L", name: "Inglaterra", emblem: "ENG" },
  { group: "L", name: "Croacia", emblem: "HR" },
  { group: "L", name: "Gana", emblem: "GH" },
  { group: "L", name: "Panama", emblem: "PA" }
];
