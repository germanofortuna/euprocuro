...
import com.euprocuro.api.entrypoints.rest.dto.request.UpdateContentReportStatusRequest;
...
public class AdminModerationController {
    ...
    public ContentReportResponse updateReportStatus(
            @PathVariable String id,
            HttpServletRequest request,
            @Valid @RequestBody UpdateContentReportStatusRequest requestBody
    ) {
        return RestMapper.toResponse(adminModerationUseCase.updateReportStatus(
                CurrentUserContext.userId(request),
                id,
